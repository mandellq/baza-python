...
# set_ = {3, 2, 1}  # Множество содержит в себе только уникальные элементы
...
# print(statistics)
# numbers = [1, 2, 3, 4, 5, 6, 2, 3, 4, 5, 6, 7, 8, -6, -6]
...
# describe = {
#     "Cумма уникальных чисел:": sum_of_numbers,
...
# print("Количество уникальных символов в строке:", len(unique_chars))